...
ggplot(data=ice.river.df,aes(x=time))+geom_line(aes(y=flow.vat),color="red")+geom_line(aes(y=flow.jok),color="blue")+labs(title="Caudales de los ríos islandeses Vatnsdalsa (azul) y Jukulsa Eystri (rojo)",y="Caudal$(m^3/s)$",caption="Fuente")
