...
iris.grafico2<-ggplot(data=iris.tidy,aes(x=Part,y=Value,color=Part))+geom_point()
...
iris.grafico4<-ggplot(data=iris.tidy,aes(x=Part,y=Value,color=Part))+geom_jitter()
iris.grafico4
